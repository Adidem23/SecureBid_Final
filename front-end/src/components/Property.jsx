...
import DisplayTenderDetails from './DisplayTenderDetails';
    ...
    const getProperty = async () =>{
      ...
      for(let i=0; i<_totalIndices; i++){
        ...
        if(ownerOwns[3].words[0] != 0){
            const landDetails = await contract.getTenderDetails(ownerOwns[0], ownerOwns[1], ownerOwns[2], ownerOwns[3].words[0], {
              from: account
            })
