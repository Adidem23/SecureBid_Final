...
const Explore = (props) => {
  ...
  const [landDetail, setLandDetail] = useState({
    owner:"", tenderId:"", index:"", marketValue:""
  })
  ...
  const handleOnClick = async () =>{
    const landDetails = await contract.getTenderDetails(explore.state, explore.district, explore.city, explore.surveyNo, {
      from: account
    })
    ...
    setLandDetail({owner, tenderId, index, marketValue, surveyNo})
