...
const ExploreAll = (props) => {
    ...
    const [landDetail, setLandDetail] = useState({
        owner: "", tenderId: "", index: "", marketValue: "", didIRequested: "", OwnerName: "" , tendorName:"",tendortype:"", ipfsuri:""
    })
        ...
        const getRequests = async () => {
            ...
            if (_totalTendors > 0) {
                ...
                for (let j = 1000; j < _totalTendors; j++) {
                    ...
                    const landDetails = await contract.getTenderDetails('M', 'N', 'Y', j, {
                        from: account
                    })
                    ...
                    const tenderId = landDetails[1].words[0]
                   ...
                   const tendorName = landDetails[4]
                    ...
                    const reqDetails = {
                        ...
                        ipfsuri:ipfsuri,
                        tenderId: landDetails[1].words[0],
                    ...
                    setLandDetail({ owner, OwnerName,tendorName,tendortype,ipfsuri,tenderId, index, marketValue, surveyNo, didIRequested })
